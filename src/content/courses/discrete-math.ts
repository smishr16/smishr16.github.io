  ...
  modules: [
    ...
    moduleOf({
      ...
      work: [
        ...
        {
          id: 'dm-m5-lab-dfs',
          title: 'Lab: DFS reachability',
          kind: 'lab',
          status: 'live',
          labId: 'graphs',
          objective: 'DFS from Gate on Campus; list discovery order; argue which vertices are reachable.',
          brief: 'graphAlgo dfs, graphId campus, start Gate. Contrast with BFS path lengths from dm-m5-lab.',
          config: { graphAlgo: 'dfs', graphId: 'campus', start: 'Gate', goal: 'Lab' },
          sources: [{ label: 'Rosen — graphs chapters', kind: 'textbook' }],
        },
        {
          id: 'dm-m5-lab-sp',
          title: 'Lab: weighted distance',
          kind: 'lab',
          status: 'live',
          labId: 'graphs',
          objective: 'Dijkstra on city-6; record shortest-path distances as a math object (not full algo proof).',
          brief: 'graphAlgo dijkstra, graphId city-6. Distances as edge-weight sums; compare to hop distance.',
          config: { graphAlgo: 'dijkstra', graphId: 'city-6' },
          sources: [{ label: 'Rosen / Algorithms bridge — shortest paths', kind: 'notes' }],
        },
      ],
    }),
    moduleOf({
      ...
      work: [
        ...
        {
          id: 'dm-m6-lab-merge',
          title: 'Lab: mergesort recurrence in motion',
          kind: 'lab',
          status: 'live',
          labId: 'sorting',
          objective: 'Step mergesort on n=8; map divide levels to T(n)=2T(n/2)+Θ(n) recursion tree.',
          brief: 'algoId merge, arraySize 8. Count levels and work-per-level; connect to dm-m6-ps Master-style case.',
          config: { algoId: 'merge', arraySize: 8 },
          sources: [{ label: 'MIT 6.042 / CLRS mergesort recurrence', kind: 'textbook' }],
        },
      ],
    }),
    moduleOf({
